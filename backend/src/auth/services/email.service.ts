...
/**
 * Sends a generic announcement/notification email to users.
 */
  ...
  await sendMail({
    ...
    html: `
      <div style="background-color: #ffffff; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; max-width: 600px; margin: auto; padding: 40px 20px; border: 1px solid #eeeeee;">
        ...
        <div style="max-width: 480px; margin: auto;">
          <h2 style="color: #000000; font-size: 20px; font-weight: 600; margin-bottom: 16px;">${title}</h2>
          <p style="color: #666666; font-size: 15px; line-height: 1.6; margin-bottom: 32px;">
            ${message.replace(/\n/g, "<br>")}
          </p>
          
          <div style="text-align: center; margin-bottom: 32px;">
            <a href="${process.env.CLIENT_URL || "#"}" style="display: inline-block; background-color: #000000; color: #ffffff; padding: 16px 32px; border-radius: 4px; text-decoration: none; font-weight: bold; font-size: 14px; text-transform: uppercase; letter-spacing: 1px;">Visit Website</a>
          </div>
          
          <p style="color: #999999; font-size: 12px; line-height: 1.5; text-align: center;">
            You are receiving this because you're a registered user of TrendMart.
          </p>
        </div>
